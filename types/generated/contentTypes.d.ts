...
export interface ApiResourcesHubResourcesHub extends Struct.SingleTypeSchema {
  collectionName: 'resources_hubs';
  info: {
    displayName: 'Resources Hub';
    pluralName: 'resources-hubs';
    singularName: 'resources-hub';
  };
  options: {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    CTAIntro: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    CTALogo: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::resources-hub.resources-hub'
    >;
    PlayCover: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    PlayIntro: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    PlayTitle: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    VideoIntro: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    WelcomeIntro: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiYellowDayYellowDay extends Struct.SingleTypeSchema {
  collectionName: 'yellow_days';
  info: {
    displayName: 'Yellow Day';
    pluralName: 'yellow-days';
    singularName: 'yellow-day';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    ResourcesBackground: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::resources-hub.resources-hub': ApiResourcesHubResourcesHub;
      'api::yellow-day.yellow-day': ApiYellowDayYellowDay;
